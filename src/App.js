...
<DepartMentCard/> */}
 ...
 <ParallaxLayer offset={1} speed={-10} factor={1} horizontal style={{
  backgroundImage:`url(${robort})`,
   backgroundPosition:'center',
...
<ParallaxLayer offset={2} speed={-10} factor={3} horizontal style={{

backgroundColor:'white',
borderRadius:'50%'

 }} >
  <ParallaxLayer offset={2} speed={-4} factor={3} horizontal style={{
    zIndex:'100'
  }}>
  <h1 className='parallel_layer_gal' >2021 Events Gallery 🎉</h1>
  </ParallaxLayer>
