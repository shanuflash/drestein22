...
import { DataGrid ,GridCellEditStopReasons,  GridFooter,
    useGridApiEventHandler,GridToolbarContainer, GridToolbarExport ,
  ...
  const handlePasteclick = (text)=>{
    ...
    return (
      <React.Fragment>
        ...
        <ContentCopyIcon onClick={()=>handlePasteclick(message)} sx={{
            marginLeft:'10px',
            cursor:'pointer'
        }}/>
        </Card>}
...
const totalAmount =paidUsers.map(data=>{
   ...
   const rows=[
    ...
    const columns= [
      ...
      { editable:false, field: 'email',type:'email', headerName: 'email', width: 150 },
      { editable:false,field:'phno',headerName:'phone no',width:150},
      { editable:false,field:'college',headerName:'college Name',minWidth:150},
      { editable:false,field:'regno',headerName:'register No',width:150},
      { editable:false,field:'gender',headerName:'gender',width:100},
      {field:'isPaid',headerName:'is Paid?',width:140,editable:true,type:'boolean'},
          {
      field: 'paymentMethod',
    ...
    { editable:false,field:'cashtobePaid',headerName:'amount',width:100},
  ...
  return (
    <StyledBox>
      ...
      <h3 style={{
        ...
        color:'black',
        marginLeft:'400px'
      }}>TOTAL AMOUT : {total}💸</h3>
      <h3 style={{
        marginTop:'-40px',
        color:'black',
        marginLeft:'700px'
      }}>RECEIVED AMOUT : {collectedcash}💸</h3>
    </StyledBox>
  );
}
